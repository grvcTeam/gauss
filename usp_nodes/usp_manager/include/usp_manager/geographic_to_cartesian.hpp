...
geometry_msgs::Point32 geographic_to_cartesian (const geographic_msgs::GeoPoint& actual_coordinate_geo, const geographic_msgs::GeoPoint& origin_geo)
{
    ...
    // These are the reasons why the x and y assignation for the Cartesian conversion isn't a simple UTM subtraction.

    // Assigning "actual_coordinate_cartesian.x" is tricky when the actual coordinate and the origin of the Cartesian coordinates are on different zones.
    ...
    // Assigning "actual_coordinate_cartesian.y" is also tricky when the actual coordinate and the origin of the Cartesian coordinates are on different hemispheres:
    ...
    {
        // The actual coordinate is in the same hemisphere that the origin (the first station). This is the normal situation, the assignation of the y axis value is trivial (simple subtraction).
        actual_coordinate_cartesian.y = actual_coordinate_UTM.northing-origin_UTM.northing;
    }

    // Assigning "actual_coordinate_cartesian.z" is trivial always, simple subtraction.
