...
def taking_off():
    take_off_url = '/M600_1/ual/take_off'
...
def track_waypoints():
    ...
    parser.add_argument('-plan_file', type=str, default='wp_default_M600_1.yaml',
    ...
    go_to_waypoint_url = '/M600_1/ual/go_to_waypoint'
